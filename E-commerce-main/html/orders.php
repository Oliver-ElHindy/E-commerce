...
$totalCustomers=mysqli_fetch_assoc($result);

$sql="Select Prod_name from products where Prod_ID=(Select Prod_ID from profit where QTY_SOLD>=(SELECT MAX(QTY_SOLD) from profit))";
$res=mysqli_query($conn,$sql);
$mostSoldProduct=mysqli_fetch_assoc($res);

$sql="Select Count(*) from orders";
$res=mysqli_query($conn,$sql);
$TotalOrders=mysqli_fetch_assoc($res);

$ThisYear=date("Y");
//$sql="Select ProfitPU*QTY_SOLD as Profit from profit where ";

$sql="Select Prod_name from products where Prod_ID=(Select Prod_ID from profit where QTY_SOLD<=(Select MIN(QTY_SOLD) from profit) Limit 1)";
$res=mysqli_query($conn,$sql);
$leastPurchasedProduct=mysqli_fetch_assoc($res);
?>
                        ...
                        <div class="card-statistic-3 p-4">
                          ...
                          <div class="row align-items-center mb-2 d-flex">
                              <div class="col-8">
                                  <h2 class="d-flex align-items-center mb-0">
                                      <?php
                                      echo $mostSoldProduct["Prod_name"];
                                      ?>
                                  </h2>
                              </div>
                           </div>
                        ...
                        <div class="card-statistic-3 p-4">
                          ...
                          <div class="row align-items-center mb-2 d-flex">
                              <div class="col-8">
                                  <h2 class="d-flex align-items-center mb-0">
                                      <?php
                                      echo $leastPurchasedProduct["Prod_name"];
                                      ?>
                                  </h2>
                              </div>
                           </div>
  ...
  <table class="table table-hover">
    ...
    while($row= mysqli_fetch_assoc($result)){
          ...
          <tr>
            ...
            <td><a href="<?php echo '../php/deleteOrder.php?id='.$row["Order_ID"];?>"><button style="background-color:red;border:none;border-radius:6px;padding:6px 20px;color:white;">Delete</button></a></td>
           <?php
        }
        ?>
    </tbody>
